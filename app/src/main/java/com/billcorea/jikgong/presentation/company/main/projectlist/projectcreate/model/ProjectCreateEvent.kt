...
sealed class ProjectCreateEvent {
  ...
  data class UpdateCategory(val category: String) : ProjectCreateEvent()
  ...
  data class UpdateMaxApplicants(val count: String) : ProjectCreateEvent()
  data class UpdateDescription(val description: String) : ProjectCreateEvent()
  data class ToggleUrgent(val isUrgent: Boolean) : ProjectCreateEvent()
